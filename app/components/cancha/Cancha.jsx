  ...
  return (
    ...
    >
        ...
        <Canvas camera={{ zoom: 1, position: [25, 10, 5], far: 2000 }}>
          ...
          {isOrbit && (
            <OrbitControls
              ...
              //     camera={
              //   Escudo.id === "Newells"
              //     ? { zoom: 1, position: [25, 10, 5] }
              //     : { zoom: 0.1, position: [25, 10, 5] }
              // }
            />
          )}
          ...
          <ScrollControls pages={4}>
            ...
            <Suspense fallback={null}>
              ...
              <Experience
                ...
                setIsScrollAnimate={setIsScrollAnimate}
                section={section}
      ...
      {isOrbit && (
        <>
          <motion.svg
            className="absolute bottom-0  w-screen m-auto"
            height="50px"
            width="50px"
            initial={{ opacity: 1, x: 0 }}
            animate={{ opacity: 0, x: 30 }}
            transition={{ repeat: 10, repeatType: "mirror", duration: 1 }}
            fill="#fff"
            version="1.1"
            id="Layer_1"
            viewBox="0 0 32 32"
      ...
      >
        <Link className={style.button} href={`/`}>
          <Tooltip showArrow={true} content="Inicio">
            <svg
              height="34px"
              width="34px"
              viewBox="0 -0.5 21 21"
        ...
        <button className={style.button} onClick={() => setNoText(!noText)}>
          {!noText ? (
            <Tooltip showArrow={true} content="Solo Cancha">
              <svg
                fill="#fff"
                height="34px"
                width="34px"
            ...
            <Tooltip showArrow={true} content="Cancha y Texto">
              <svg
                fill="#fff"
        ...
        {!isOrbit ? (
          ...
          >
            <Tooltip showArrow={true} content="Mover Camara">
              <svg
                height="34px"
                width="34px"
                style={
          ...
          >
            <Tooltip
              showArrow={true}
              content={isRotate ? "No Rotar " : "Rotar"}
            >
              <svg
                height="34px"
                width="34px"
        ...
        <button className={style.button} onClick={() => setisOrbit(!isOrbit)}>
          {!isOrbit ? (
            <Tooltip showArrow={true} content="Free Cam">
              <svg
                fill="#fff"
                height="34px"
                width="34px"
            ...
            <Tooltip showArrow={true} content="Cam Fija">
              <svg
                fill="#f00"
                height="34px"
                width="34px"
      ...
      <AnimatePresence>
        {isScroll && (
          <motion.div
            onClick={() => setIsScrollAnimate(true)}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className={style.top}
